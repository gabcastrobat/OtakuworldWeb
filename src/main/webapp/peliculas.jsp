...
<div class="page-hero">
    ...
    <p>Las mejores producciones cinematográficas del anime — desde clásicos de Ghibli hasta los últimos estrenos.</p>
    <span class="count-badge" id="contadorPelis">10 películas</span>
</div>
    ...
    <div class="col peli-item" data-titulo="akira" data-genero="sci-fi acción">
        <div class="ow-card">
            ...
            <div class="ow-card-body">
                ...
                <span class="ow-genre-tag">Sci-Fi</span><span class="ow-genre-tag">Acción</span>
                <a href="#" class="ow-card-btn">▶ Ver ahora</a>
            </div>
        </div>
    </div>
    ...
    <div class="col peli-item" data-titulo="nausicaä del valle del viento" data-genero="sci-fi aventura">
        <div class="ow-card">
            ...
            <div class="ow-card-body">
                ...
                <span class="ow-genre-tag">Sci-Fi</span><span class="ow-genre-tag">Aventura</span>
                <a href="#" class="ow-card-btn">▶ Ver ahora</a>
            </div>
        </div>
    </div>
...
<div class="ow-no-results" id="sinResultadosPelis">Sin películas para tu búsqueda 😔</div>
